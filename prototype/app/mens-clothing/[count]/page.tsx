...
export default async function Page(count:ProductCount) {
  ...
  return (
    ...
    <Pannel spacing={{ xs: 2}}>
      <Item xs={0.5}></Item>
      <Item xs={3.5}>
        <Label sx={{ width: '100%', maxWidth: 500,fontWeight: 'bold', fontSize:20 }}  variant="subtitle2" text="Men's Clothing"  />
      </Item>
      <Item  xs={4}>
      </Item>
      <Item  xs={4}>
            ...
            <Fragment key={index}>
              <Item xs={2} sm={4} md={4} >
                <Margins style={{marginLeft:"5em",marginRight:"5em"}}>
                  ...
                  <ClothFrame variant="elevation" elevation={1} sx={{position:'relative',top:'-1em',backgroundColor: "#2BD9AF"}}>
